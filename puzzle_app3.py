...
def writeSTL(facets, file_name, ascii=False):
    ...
    completeName = os.path.join('uploads/', file_name)
    #completeName = os.path.join('C:/Users/Alecto/Google Drive/Fall 2015/Applied Fabrication/Fab Final Project/website/uploads', file_name)
...
def make_puzzle_from_img(filename):
    ...
    numpy2stl(C, finalname, scale=0.05, mask_val=5., max_width=100, max_depth=100, max_height=130, solid=True)
